...
class DP_Coverflow extends WP_Widget
{
  
  function DP_Coverflow()
  {
    $widget_ops = array('classname' => 'dp-coverflow', 'description' => "Allows you to pick a gallery from the 'NextGen Gallery' plugin to use as Coverflow.");
    $this->WP_Widget('dp-coverflow', 'Digital Pioneers', $widget_ops);
  }
  ...
  function widget($args, $instance)
  {
    ...
    {         
      ...
      $output .= "\n  <ul id=\"" . $html_id . "\" class=\"dpCoverflow hasReflection\">";
      $image_alt = null;
      ...
      foreach($results as $result) 
      {
        ...
        $output .= "<img src=\"" . $image->imageURL . "\" " . $image_description . " border=\"0\" />";
